...
In this early stage, please report [unexpected package behavior in an issue on GitHub](https://github.com/stephenholzman/tidyusafec/issues).
...
```{r, eval = FALSE, include = FALSE}
ggsave(filename = "receipts-by-type-total-example.png", width = 11, height = 5)
```
