...
## Installing the tidyusafec R package
...
## Registering for an API Key and Saving It
...
The results of a `search_candidates` can be piped (using `%>%`) into one of the appropriate functions that begin with a `get_` prefix.
